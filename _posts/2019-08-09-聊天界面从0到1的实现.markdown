...
## 键盘切换
先看一下我所实现的效果。
{% asset_img images/02_post/jianpantanchu.gif  键盘弹出,上面的视图向上滑动%}
...
{% asset_img jianpanbeifugai.gif  键盘切换过程中小部分覆盖问题%}
...
{% asset_img images/02_post/gengduojianpan.jpg ‘更多’键盘%}
...
{% asset_img biaoqingbaofenye.gif 表情包组的切换 %}
